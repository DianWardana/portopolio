...
export const profile = {
  ...
  tagline:
    'Saya menjaga server tetap hidup, jaringan tetap stabil, dan 400+ user tetap produktif — termasuk saat tidak ada yang sadar ada masalah.',
...
export const metrik = [
  ...
  { nilai: 400, sufiks: '+', label: 'User aktif dikelola', catatan: 'high demand environment' },
]
...
export const stack = [
  ...
  { nama: 'Ruijie', kategori: 'Network', level: 5, catatan: 'Whitelist management, AP Mesh deployment, AI Roaming optimization' },
  ...
  // Field
  { nama: 'NVR & CCTV', kategori: 'Field', level: 4, catatan: 'instalasi indoor & outdoor' },
...
export const projects = [
  {
    judul: 'Deploy & Manage 4 Server Development,On Premise, VPS, Backup',
